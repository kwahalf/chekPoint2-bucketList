...
class AuthTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.user_data = {"email":"test@example.com", "password":"test_password"}
    ...
    def test_registration(self):
        ...
        res = self.client.post('/auth/register', data=json.dumps(self.user_data),
    ...
    def test_user_login(self):
        ...
        res = self.client.post('/auth/register', data=json.dumps(self.user_data),
                               headers = {'content-type': 'application/json'})
        self.assertEqual(res.status_code, 201)
        login_res = self.client.post('/auth/login', data=json.dumps(self.user_data),
                               headers = {'content-type': 'application/json'})
